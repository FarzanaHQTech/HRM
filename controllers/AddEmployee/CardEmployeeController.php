...
class CardEmployeeController
{
    ...
    function save()
    {
        if (isset($_POST['btnCreate'])) {
            ...
            $saveObj = new Allemployee($first_name,$last_name,$user_id,$image_name,$email,$password,$mobile,$department_id,$designation_id,$role_id,$dob,$address,$gender,$martial_status_id,$joining_date,$payroll_id,$experience,$status_id,$company_id);
            // print_r($saveObj);
            // die();
