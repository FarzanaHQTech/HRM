    ...
    <div class="page-header">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-end ms-auto">
                ...
                <a href="<?php echo $base_url?>/leave/create" class="btn add-btn"  data-bs-target="#add_leave"><i class="fa fa-plus"></i> Add Leave</a>
                            ...
                            <table class="table table-striped custom-table mb-0 datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th  rowspan="1" colspan="1" aria-label="From: activate to sort column ascending" style="width: 73.0156px;">From</th>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
                                    ...
                                    <!-- <tr class="odd">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-08.jpg" alt="User Image"></a>
                                    ...
                                    <tr class="even">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-20.jpg" alt="User Image"></a>
                                    ...
                                    <tr class="even">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-10.jpg" alt="User Image"></a>
                                    ...
                                    <tr class="even">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-05.jpg" alt="User Image"></a>
                                    ...
                                    <tr class="odd">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-09.jpg" alt="User Image"></a>
                                    ...
                                    <tr class="even">
                                        <td class="sorting_1">
                                            <h2 class="table-avatar">
                                                <a href="https://smarthr.dreamstechnologies.com/laravel/template/public/profile" class="avatar"><img src="https://smarthr.dreamstechnologies.com/laravel/template/public/assets/img/profiles/avatar-24.jpg" alt="User Image"></a>
