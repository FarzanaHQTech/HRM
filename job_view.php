...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="header">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow flag-nav">
						<a class="nav-link dropdown-toggle job-view-flag" data-bs-toggle="dropdown" href="#" role="button">
			...
			<!-- Page Wrapper -->
            <div class="page-wrapper job-wrapper" style="min-height: 607px;">
						...
						<div class="col-md-8">
							<div class="job-info job-widget">
								...
								<ul class="job-post-det">
									<li><i class="fa-regular fa-calendar-days"></i> Post Date: <span class="text-blue">Feb 18, 2019</span></li>
									<li><i class="fa-regular fa-calendar-days"></i> Last Date: <span class="text-blue">May 31, 2019</span></li>
